...
<template>
  <Layout>
    ...
    <b-row>
      ...
      <b-col xl="3" md="6">
        <b-card no-body class="card-animate bg-secondary">
          <b-card-body>
            <div class="d-flex align-items-center">
              <div class="flex-grow-1">
              ...
              <div>
                <div class="avatar-sm flex-shrink-0">
                  <span class="avatar-title bg-soft-info rounded-circle fs-2">
                    <UsersIcon height="24px" width="24px" class="text-info"></UsersIcon>
                  </span>
                </div>
              </div>
            </div>
          ...
          <b-card-body>
            <div class="d-flex justify-content-between">
              ...
              <div>
                <div class="avatar-sm flex-shrink-0">
                  <span class="avatar-title bg-soft-info rounded-circle fs-2">
                    <ActivityIcon height="24px" width="24px" class="text-info"></ActivityIcon>
                  </span>
                </div>
              </div>
            </div>
              ...
              <div>
                <div class="avatar-sm flex-shrink-0">
                  <span class="avatar-title bg-soft-light rounded-circle fs-2">
                    <ClockIcon height="24px" width="24px" class="text-white"></ClockIcon>
                  </span>
                </div>
              </div>
            </div>
          ...
          <b-card-body>
            <div class="d-flex justify-content-between">
              ...
              <div>
                <div class="avatar-sm flex-shrink-0">
                  <span class="avatar-title bg-soft-info rounded-circle fs-2">
                    <ExternalLinkIcon height="24px" width="24px" class="text-info"></ExternalLinkIcon>
                  </span>
                </div>
              </div>
            </div>
    ...
    <b-row>
      <b-col xl="3" md="6">
        <b-card no-body class="bg-danger card-height-100">
          <b-card-body>
            <div class="d-flex align-items-center">
              <div class="avatar-sm flex-shrink-0">
    ...
    <b-row>
      <b-col lg="4">
        <b-card no-body>
          <b-card-body>
            <h5 class="fs-16 fw-semibold">Brand Logo Design - MD</h5>
      ...
      <b-col lg="4">
        <b-card no-body>
          <b-card-body>
            <h5 class="fs-16 fw-semibold">Redesign - Landing Page</h5>
      ...
      <b-col lg="4">
        <b-card no-body>
          <b-card-body>
            <h5 class="fs-16 fw-semibold">Ecommerce App for Web</h5>
