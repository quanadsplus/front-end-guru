...
<template>
  <Layout>
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0">
                <div class="d-flex flex-wrap gap-2">
                  ...
                  <b-button variant="secondary" class="me-1" id="remove-actions" @click="deleteMultiple">
              ...
              <b-row class="g-3">
                ...
                <b-col xxl="3" sm="4">
                  <div class="input-light">
                    <Multiselect placeholder="Select Status" v-model="filtervalue1" :close-on-select="true" :searchable="true" :create-option="true"
                      :options="[
                        { value: 'All', label: 'All' },
    ...
    <b-modal v-model="modalShow" id="showModal" modal-class="zoomIn" title-class="exampleModalLabel" hide-footer
      ...
      <form id="addform" class="tablelist-form" autocomplete="off">
        <b-row class="g-3">
          <b-col lg="12">
            <div id="modal-id">
