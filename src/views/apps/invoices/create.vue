              ...
              <b-row class="g-3">
                ...
                <b-col lg="3" sm="6">
                  ...
                  <div class="input-light">
                    <Multiselect class="form-control w-md" placeholder="Select Payment Status" id="paymentstatus" v-model="paymentvalue"
            ...
            <b-card-body class="p-4">
                ...
                <table class="invoice-table table table-borderless table-nowrap mb-0">
                  ...
                  <tbody id="newlink">
                    ...
                    <tr v-for="n in count" :key="n" :id="n" class="product">
                      ...
                      <td class="text-start">
                        <Multiselect class="form-control w-md" placeholder="Select Product" v-model="newproductvalue[n - 1]" :close-on-select="true"
                      ...
                      <td class="product-removal">
                        <b-link href="javascript:void(0)" class="btn btn-success">Delete</b-link>
                      </td>
                    </tr>
                  ...
                  <tr>
                    <td colspan="9">
                      <b-link @click="new_link" class="btn btn-soft-secondary fw-medium"><i
                  ...
                  <div class="mb-2">
                    ...
                    <div class="input-light">
                      <Multiselect class="form-control w-md" v-model="value" :close-on-select="true" :searchable="true"
                        :create-option="true" placeholder="Select Payment Method" :options="[
              ...
              <div class="hstack gap-2 justify-content-end d-print-none mt-4">
                ...
                <b-link href="javascript:void(0);" class="btn btn-primary"><i
                  ...
                  Invoice</b-link>
                <b-link href="javascript:void(0);" class="btn btn-danger"><i
