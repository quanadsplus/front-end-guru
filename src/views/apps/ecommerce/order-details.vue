          ...
          <b-card-header>
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0">
                <router-link to="/invoices/detail" class="btn btn-secondary btn-sm"><i
          ...
          <b-card-header>
            <div class="d-sm-flex align-items-center">
              ...
              <div class="flex-shrink-0 mt-2 mt-sm-0">
                <b-link href="javascript:void(0);" class="btn btn-soft-info btn-sm mt-2 mt-sm-0"><i
                    class="ri-map-pin-line align-bottom me-1"></i> Change
                  Address</b-link>
                <b-link href="javascript:void(0);" class="btn btn-soft-danger btn-sm mt-2 mt-sm-0 ms-1"><i
                    class="mdi mdi-archive-remove-outline align-bottom me-1"></i>
                  Cancel Order</b-link>
              </div>
            </div>
          </b-card-header>
