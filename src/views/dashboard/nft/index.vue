                        ...
                        <b-card no-body class="overflow-hidden">
                            <b-card-body class="bg-marketplace d-flex">
                                <div class="flex-grow-1">
                                    <h4 class="fs-18 lh-base fw-semibold mb-0">Discover, Collect, Sell and Create <br> your
                                        own <span class="text-success">NFTs.</span> </h4>
                                    <p class="mb-0 mt-2 pt-1 text-muted">The world's first and largest digital
                                        marketplace.</p>
                                    <div class="d-flex gap-3 mt-4">
                                        <b-link href="" class="btn btn-secondary">Discover Now </b-link>
                                        <b-link href="" class="btn btn-danger">Create Your Own</b-link>
                                    </div>
                                </div>
