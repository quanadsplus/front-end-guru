                              ...
                              <b-card no-body class="profile-project-card shadow-none profile-project-success mb-0">
                                <b-card-body class="p-4">
                                  <div class="d-flex">
                                    ...
                                    <div class="flex-shrink-0 ms-2">
                                      <b-badge variant="soft-warning" class="badge-soft-warning fs-11">
                                        Inprogress
                                      </b-badge>
                                    </div>
                                  </div>
                              ...
                              <b-card no-body class="profile-project-card shadow-none profile-project-danger mb-0">
                                <b-card-body class="p-4">
                                  <div class="d-flex">
                                    ...
                                    <div class="flex-shrink-0 ms-2">
                                      <b-badge variant="soft-success" class="badge-soft-success fs-11">
                                        Completed
                                      </b-badge>
                                    </div>
                                  </div>
                      ...
                      <b-card no-body class="profile-project-card shadow-none profile-project-success">
                        <b-card-body class="p-4">
                          <div class="d-flex">
                            ...
                            <div class="flex-shrink-0 ms-2">
                              <b-badge variant="soft-primary" class="badge-soft-primary fs-11">
                                Progress
                              </b-badge>
                            </div>
                          </div>
                      ...
                      <b-card no-body class="profile-project-card shadow-none profile-project-info">
                        <b-card-body class="p-4">
                          <div class="d-flex">
                            ...
                            <div class="flex-shrink-0 ms-2">
                              <b-badge variant="soft-info" class="badge-soft-info fs-11">New</b-badge>
                            </div>
                          </div>
