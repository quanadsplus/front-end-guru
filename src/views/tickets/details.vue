                ...
                <b-card no-body>
                    <b-card-body class="p-4">
                        ...
                        <div class="mt-4">
                            ...
                            <div>
                                <pre class="language-markup rounded-2 text-muted"><code>var app = document.getElementById(&quot;app&quot;);
                        ...
                        <div data-simplebar style="height: 300px;" class="px-3 mx-n3">
                            <div class="d-flex mb-4">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h5 class="fs-15">Joseph Parker <small class="text-muted">20 Dec 2021 -
                                            05:47AM</small></h5>
                                    ...
                                    <div class="d-flex mt-4">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h5 class="fs-15">Alexis Clarke <small class="text-muted">22 Dec 2021 -
                                                    02:32PM</small></h5>
                            ...
                            <div class="d-flex mb-4">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h5 class="fs-15">Donald Palmer <small class="text-muted">24 Dec 2021 -
                                            05:20PM</small></h5>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-flex mt-4">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h5 class="fs-15">Donald Palmer <small class="text-muted">8 sec ago</small>
                                            </h5>
