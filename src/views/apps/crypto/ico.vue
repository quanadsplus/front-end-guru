    ...
    <b-card no-body>
      <b-card-body>
        <b-row class="g-3">
          ...
          <b-col xxl="2" lg="4">
            <Multiselect class="form-control" placeholder="Select Status" v-model="value" :close-on-select="true" :searchable="true"
          ...
          <b-col xxl="2" lg="4">
            <Multiselect class="form-control" placeholder="Select Rating" v-model="value1" :close-on-select="true" :searchable="true"
              :create-option="true" :options="[
