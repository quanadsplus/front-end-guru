            ...
            <div class="tasks-list">
                <div class="d-flex mb-3">
                    <div class="flex-grow-1">
                        <h6 class="fs-14 text-uppercase fw-semibold mb-0">Unassigned <b-badge tag="small" variant="danger" class="align-bottom ms-1">2</b-badge></h6>
                    </div>
                                ...
                                <b-card-body>
                                    <div class="d-flex mb-2">
                                        <h6 class="fs-16 mb-0 flex-grow-1 text-truncate">
                                            <router-link to="/apps/tasks-details" class="link-dark d-block">{{ data.title }}</router-link>
                                        </h6>
                                        <div class="dropdown">
