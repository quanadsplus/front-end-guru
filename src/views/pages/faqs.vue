                        ...
                        <div class="mt-3">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="fs-17 mb-0 fw-semibold">General Questions</h5>
                                </div>
                            </div>
                    ...
                    <b-col lg="4">
                        <div class="mt-3">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="fs-17 mb-0 fw-semibold">Manage Account</h5>
                                </div>
                            </div>
                    ...
                    <b-col lg="4">
                        <div class="mt-3">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="fs-17 mb-0 fw-semibold">Privacy &amp; Security</h5>
                                </div>
                            </div>
