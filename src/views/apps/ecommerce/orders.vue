            ...
            <b-row class="align-items-center gy-3">
              ...
              <b-col sm="auto">
                <div class="d-flex gap-1 flex-wrap">
                  <b-button type="button" variant="primary" class="add-btn" id="create-btn"
                  @click="createModal = !createModal">
                  <i class="ri-add-line align-bottom me-1"></i> Create Order
                </b-button>
                <b-button type="button" variant="secondary" class="ms-1">
                ...
                <b-col xxl="2" sm="4">
                  <div>
                    <Multiselect class="form-control" v-model="status1" :close-on-select="true" :searchable="true"
                      :create-option="true" @input="onChangePayment" placeholder="Select Status" :options="[
  { value: 'All', label: 'All' },
                ...
                <b-col xxl="2" sm="4">
                  <div>
                    <Multiselect class="form-control" v-model="value1" :close-on-select="true" :searchable="true"
                      :create-option="true" @input="onChangeStatus" placeholder="Select Payment" :options="[
  { value: 'All', label: 'All' },
          ...
          <b-card-body class="pt-0">
            <div>
              <ul class="nav nav-tabs nav-tabs-custom nav-success mb-3" role="tablist">
                ...
                <li class="nav-item">
                  <b-link class="nav-link py-3 Delivered" data-bs-toggle="tab" id="Delivered" href="#delivered"
                    role="tab" @click="changecategory('Delivered')" aria-selected="false">
                ...
                <li class="nav-item">
                  <b-link class="nav-link py-3 Cancelled" data-bs-toggle="tab" id="Cancelled" href="#cancelled"
                    role="tab" @click="changecategory('Cancelled')" aria-selected="false">
