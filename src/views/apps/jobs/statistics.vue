  ...
  setup() {
    return {
      ...
      yournetworkchartchartOptions: {
        ...
        colors: getChartColorsArray('["--vz-info", "--vz-secondary"]'),
        xaxis: {
              ...
              <table class="table table-borderless table-sm table-centered align-middle table-nowrap mb-0">
                <tbody class="border-0">
                  ...
                  <tr>
                    <td>
                      <h4 class="text-truncate fs-14 fs-medium mb-0"><i
                          class="ri-stop-fill align-middle fs-18 text-secondary me-2"></i>Mobile Users</h4>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td>
                      <h4 class="text-truncate fs-14 fs-medium mb-0"><i
                          class="ri-stop-fill align-middle fs-18 text-warning me-2"></i>Tablet Users</h4>
                    </td>
                    <td>
