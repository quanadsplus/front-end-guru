                    ...
                    <b-col lg="4" class="product-item music crypto-card games">
                        <b-card no-body class="explore-box card-animate">
                            ...
                            <b-card-body>
                                ...
                                <h5 class="mb-1">
                                    <router-link to="/apps/nft-item-detail" class="link-dark">The
                                        Chirstoper</router-link>
                                </h5>
                    ...
                    <b-col lg="4" class="product-item artwork music games">
                        <b-card no-body class="explore-box card-animate">
                            ...
                            <b-card-body>
                                ...
                                <h5 class="mb-1">
                                    <router-link to="/apps/nft-item-detail" class="link-dark">Evolved
                                        Reality</router-link>
                                </h5>
                    ...
                    <b-col lg="4" class="product-item crypto-card 3d-style">
                        <b-card no-body class="explore-box card-animate">
                            ...
                            <b-card-body>
                                ...
                                <h5 class="mb-1">
                                    <router-link to="/apps/nft-item-detail" class="link-dark">Abstract Face
                    ...
                    <b-col lg="4" class="product-item artwork music crypto-card">
                        <b-card no-body class="explore-box card-animate">
                            ...
                            <b-card-body>
                                ...
                                <h5 class="mb-1">
                                    <router-link to="/apps/nft-item-detail" class="link-dark">Robotic Body
                                        Art</router-link>
                                </h5>
                                <p class="text-muted mb-0">Artwork</p>
                            </b-card-body>
                                    ...
                                    <b-card no-body>
                                        <b-card-body>
                                            ...
                                            <b-link href="#!" class="float-end"> View All <i
                                                    class="ri-arrow-right-line align-bottom"></i></b-link>
                                            <h5 class="mb-0 fs-16">
                                                <b-link href="#!" class="link-dark">Artwork <b-badge
                                                        variant="soft-success" class="badge-soft-success">206</b-badge>
                                                </b-link>
                                            </h5>
                                        </b-card-body>
                                    </b-card>
                                    ...
                                    <b-card no-body>
                                        <b-card-body>
                                            ...
                                            <b-link href="#!" class="float-end"> View All <i
                                                    class="ri-arrow-right-line align-bottom"></i></b-link>
                                            <h5 class="mb-0 fs-16">
                                                <b-link href="#!" class="link-dark">Crypto Card <b-badge
                                                        variant="soft-success" class="badge-soft-success">743</b-badge>
                                                </b-link>
                                            </h5>
                                        </b-card-body>
                                    </b-card>
                                        ...
                                        <b-card no-body>
                                            <b-card-body>
                                                ...
                                                <b-link href="#!" class="float-end"> View All <i
                                                        class="ri-arrow-right-line align-bottom"></i></b-link>
                                                <h5 class="mb-0 fs-16">
                                                    <b-link href="#!" class="link-dark">Music <b-badge
                                    ...
                                    <b-card no-body>
                                        <b-card-body>
                                            ...
                                            <b-link href="#!" class="float-end"> View All <i
                                                    class="ri-arrow-right-line align-bottom"></i></b-link>
                                            <h5 class="mb-0 fs-16">
                                                <b-link href="#!" class="link-dark">Games <b-badge
                                                        variant="soft-success" class="badge-soft-success">341</b-badge>
                                                </b-link>
                                            </h5>
                                        </b-card-body>
                                    </b-card>
                                    ...
                                    <b-card no-body>
                                        <b-card-body>
                                            ...
                                            <b-link href="#!" class="float-end"> View All <i
                                                    class="ri-arrow-right-line align-bottom"></i></b-link>
                                            <h5 class="mb-0 fs-16">
                                                <b-link href="#!" class="link-dark">Photography <b-badge
                                                        variant="soft-success" class="badge-soft-success">1452</b-badge>
                                                </b-link>
                                            </h5>
                                        </b-card-body>
                                    </b-card>
