                ...
                <b-card-body>
                  ...
                  <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                      ...
                      <b-link href="" class="text-decoration-underline text-muted">View net earnings</b-link>
                    </div>
                ...
                <b-card-body>
                  ...
                  <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                      ...
                      <b-link href="" class="text-decoration-underline text-muted">View all orders</b-link>
                    </div>
                    <div class="avatar-sm flex-shrink-0">
                ...
                <b-card-body>
                  ...
                  <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                      ...
                      <b-link href="" class="text-decoration-underline text-muted">See details</b-link>
                    </div>
                    <div class="avatar-sm flex-shrink-0">
                ...
                <b-card-body>
                  ...
                  <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                      ...
                      <b-link href="" class="text-decoration-underline text-muted">Withdraw money</b-link>
                    </div>
                    <div class="avatar-sm flex-shrink-0">
                  ...
                  <div class="flex-shrink-0">
                    <div class="dropdown card-header-dropdown">
                      <b-link class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">
                        <span class="fw-semibold text-uppercase fs-13">Sort by: </span><span class="text-muted">Today<i
        ...
        <div class="layout-rightside">
          <b-card no-body class="h-100 rounded-0">
            <b-card-body class="p-0">
              <div class="p-3">
                <h6 class="text-muted mb-0 text-uppercase fw-semibold fs-13">
                  Recent Activity
                </h6>
              </div>
              ...
              <div class="p-3 mt-2">
                <h6 class="text-muted mb-3 text-uppercase fw-semibold fs-13">
                  Top 10 Categories
                </h6>
