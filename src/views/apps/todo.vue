            ...
            document.getElementById("addNewProject").addEventListener("click", function () {
                ...
                const projectlisthtml =
                    '<li id="projectlist-' + uniqueid + '">\
                        <a data-bs-toggle="collapse" href="#projectCollapse-'+ uniqueid + '" class="nav-link fs-14">' + projectName + '</a>\
                ...
                <div class="p-4 d-flex flex-column h-100">
                    ...
                    <div class="px-4 mx-n4" data-simplebar style="height: calc(100vh - 468px);">
                        <ul class="to-do-menu list-unstyled" id="projectlist-data">
                            <li>
                                <b-link v-b-toggle.velzonAdmin class="nav-link fs-14 active">
                                    Velzon
                            ...
                            <li>
                                <b-link v-b-toggle.projectManagement class="nav-link fs-14">
                                    Project
                                    Management</b-link>
                            ...
                            <li>
                                <b-link v-b-toggle.skoteAdmin class="nav-link fs-14">Skote Admin
                                    &
                                    Dashboard</b-link>
                            ...
                            <li>
                                <b-link v-b-toggle.ecommerceProject class="nav-link fs-14">Doot -
                                    Chat
                                    App Template</b-link>
                                    ...
                                    <tr v-for="(singleTodo, index) of this.resultQuery" :key="index">
                                        ...
                                        <td>
                                            <div class="hstack gap-2">
                                                ...
                                                <b-button variant="soft-primary" size="sm" class="edit-list"
