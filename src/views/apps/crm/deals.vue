                ...
                <b-row class="g-3">
                    ...
                    <b-col md="auto" class="ms-auto">
                        <div class="d-flex hastck gap-2 flex-wrap">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-soft-info btn-icon fs-15" type="button" id="dropdownMenuButton1"
                ...
                <b-collapse id="leadDiscovered" visible>
                    <b-card no-body class="mb-1">
                        ...
                        <b-collapse class="border-top border-top-dashed" id="leadDiscovered1">
                            <b-card-body>
                                <h6 class="fs-15 mb-1">Nesta Technologies <b-badge tag="small" variant="soft-danger" class="badge-soft-danger">4
                                        Days</b-badge></h6>
                ...
                <b-collapse id="contactInitiated" visible>
                    ...
                    <b-card no-body class="mb-1">
                        ...
                        <b-collapse class="border-top border-top-dashed" id="contactInitiated2">
                            <b-card-body>
                                <h6 class="fs-15 mb-1">Zoetic Fashion <b-badge tag="small" variant="soft-warning" class="badge-soft-warning">25
                                        Days</b-badge></h6>
                                <p class="text-muted">As a company grows however, you find it's not as easy to shout
                                    across</p>
                                <ul class="list-unstyled vstack gap-2 mb-0">
                    ...
                    <b-card no-body class="mb-1">
                        ...
                        <b-collapse class="border-top border-top-dashed" id="contactInitiated3">
                            <b-card-body>
                                <h6 class="fs-15 mb-1">Micro Design <b-badge tag="small" variant="soft-success" class="badge-soft-success">2
                                        Month</b-badge></h6>
                                <p class="text-muted">As a company grows however, you find it's not as easy to shout
                                    across</p>
                                <ul class="list-unstyled vstack gap-2 mb-0">
                ...
                <b-collapse id="needsIdentified" visible>
                    <b-card no-body class="mb-1">
                        ...
                        <b-collapse class="border-top border-top-dashed" id="needsIdentified1">
                            <b-card-body>
                                <h6 class="fs-15 mb-1">Alexis Clarke <b-badge tag="small" variant="soft-danger" class="badge-soft-danger">7
                                        Days</b-badge></h6>
                                <p class="text-muted">As a company grows however, you find it's not as easy to shout
                                    across</p>
                                <ul class="list-unstyled vstack gap-2 mb-0">
                    ...
                    <b-card no-body class="mb-1">
                        ...
                        <b-collapse class="border-top border-top-dashed" id="needsIdentified2">
                            <b-card-body>
                                <h6 class="fs-15 mb-1">Meta4Systems <b-badge variant="soft-warning" class="badge-soft-warning">35
                                        Days</b-badge></h6>
                                <p class="text-muted">As a company grows however, you find it's not as easy to shout
                                    across</p>
                                <ul class="list-unstyled vstack gap-2 mb-0">
                    ...
                    <b-card no-body class="mb-1">
                        ...
                        <b-collapse class="border-top border-top-dashed" id="needsIdentified3">
                            <b-card-body>
                                <h6 class="fs-15 mb-1">Syntyce Solutions <b-badge variant="soft-danger" class="badge-soft-danger">15
                                        Days</b-badge></h6>
                                <p class="text-muted">As a company grows however, you find it's not as easy to shout
                                    across</p>
                                <ul class="list-unstyled vstack gap-2 mb-0">
                    ...
                    <b-card no-body class="mb-1 ribbon-box ribbon-fill ribbon-sm">
                        ...
                        <b-collapse class="border-top border-top-dashed" id="needsIdentified4">
                            <b-card-body>
                                <h6 class="fs-15 mb-1">Themesbrand <b-badge tag="small" variant="soft-danger" class="badge-soft-danger">3
                                        Month</b-badge></h6>
                                <p class="text-muted">As a company grows however, you find it's not as easy to shout
                                    across</p>
                                <ul class="list-unstyled vstack gap-2 mb-0">
                    ...
                    <b-card no-body class="mb-1 ribbon-box ribbon-fill ribbon-sm">
                        ...
                        <b-collapse class="border-top border-top-dashed" id="needsIdentified5">
                            <b-card-body>
                                <h6 class="fs-15 mb-1">Themesbrand <b-badge tag="small" variant="soft-danger" class="badge-soft-danger">3 Days</b-badge>
                                </h6>
                                <p class="text-muted">As a company grows however, you find it's not as easy to shout
                                    across</p>
                                <ul class="list-unstyled vstack gap-2 mb-0">
                    ...
                    <b-card no-body class="mb-1">
                        ...
                        <b-collapse class="border-top border-top-dashed" id="needsIdentified6">
                            <b-card-body>
                                <h6 class="fs-15 mb-1">iTest Factory <b-badge variant="soft-warning" tag="small" class="badge-soft-warning">42
                                        Days</b-badge></h6>
                                <p class="text-muted">As a company grows however, you find it's not as easy to shout
                                    across</p>
                                <ul class="list-unstyled vstack gap-2 mb-0">
                    ...
                    <b-card no-body>
                        ...
                        <b-collapse class="border-top border-top-dashed" id="needsIdentified7">
                            <b-card-body>
                                <h6 class="fs-15 mb-1">Meta4Systems <b-badge tag="small" variant="soft-success" class="badge-soft-success">6
                                        Month</b-badge></h6>
                                <p class="text-muted">As a company grows however, you find it's not as easy to shout
                                    across</p>
                                <ul class="list-unstyled vstack gap-2 mb-0">
                ...
                <b-collapse id="meetingArranged" visible>
                    <b-card no-body class="mb-1">
                        ...
                        <b-collapse class="border-top border-top-dashed" id="meetingArranged1">
                            <b-card-body>
                                <h6 class="fs-15 mb-1">Nesta Technologies <b-badge tag="small" variant="soft-danger" class="badge-soft-danger">10
                                        Days</b-badge ></h6>
                                <p class="text-muted">As a company grows however, you find it's not as easy to shout
                                    across</p>
                                <ul class="list-unstyled vstack gap-2 mb-0">
                ...
                <b-collapse id="offerAccepted" visible>
                    ...
                    <b-card no-body class="mb-1 ribbon-box ribbon-fill ribbon-sm">
                        ...
                        <b-collapse class="border-top border-top-dashed" id="offerAccepted2">
                            <b-card-body>
                                <h6 class="fs-15 mb-1">Nesta Technologies <b-badge tag="small" variant="soft-warning" class="badge-soft-warning">47
                                        Days</b-badge></h6>
                                <p class="text-muted">As a company grows however, you find it's not as easy to shout
                                    across</p>
                                <ul class="list-unstyled vstack gap-2 mb-0">
                    ...
                    <b-card no-body class="mb-1">
                        ...
                        <b-collapse class="border-top border-top-dashed" id="offerAccepted4">
                            <b-card-body>
                                <h6 class="fs-15 mb-1">Nesta Technologies <b-badge tag="small" variant="soft-success" class="badge-soft-success">4
                                        Month</b-badge></h6>
                                <p class="text-muted">As a company grows however, you find it's not as easy to shout
                                    across</p>
                                <ul class="list-unstyled vstack gap-2 mb-0">
                    ...
                    <b-card no-body class="mb-1 ribbon-box ribbon-fill ribbon-sm">
                        ...
                        <b-collapse class="border-top border-top-dashed" id="offerAccepted6">
                            <b-card-body>
                                <h6 class="fs-15 mb-1">Nesta Technologies <b-badge tag="small" variant="soft-danger" class="badge-soft-danger">14
                                        Days</b-badge></h6>
                                <p class="text-muted">As a company grows however, you find it's not as easy to shout
                                    across</p>
                                <ul class="list-unstyled vstack gap-2 mb-0">
