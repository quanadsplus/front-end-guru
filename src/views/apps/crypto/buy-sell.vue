            ...
            <div class="tab-content text-muted">
                ...
                <div class="p-3">
                  ...
                  <div class="mt-3 pt-2">
                    <div class="d-flex mb-2">
                      <div class="flex-grow-1">
                        <p class="mb-0">
                          Transaction Fees<span class="text-muted ms-1 fs-12">(0.05%)</span>
                        </p>
                      </div>
                    ...
                    <div class="d-flex mb-2">
                      <div class="flex-grow-1">
                        <p class="mb-0">
                          Minimum Received<span class="text-muted ms-1 fs-12">(2%)</span>
                        </p>
                      </div>
                      <div class="flex-shrink-0">
              ...
              <div class="tab-pane" id="cryptoSell" role="tabpanel">
                ...
                <div class="p-3">
                  ...
                  <div class="mt-3 pt-2">
                    <b-button type="button" variant="danger" class="w-100">
                      Sell Coin
                    </b-button>
                  </div>
                </div>
              ...
              <tr v-for="(data, index) of resultQuery" :key="index">
                ...
                <td>
                  <div class="d-flex align-items-center fw-medium">
                    ...
                    <b-link href="javascript:void(0);" class="currency_name">{{
                        data.currency_name
                    }}</b-link>
                  </div>
                </td>
                ...
                <td>
                  <b-button variant="soft-info" size="sm">Trade Now</b-button>
                </td>
              </tr>
            </tbody>
          </table>
