            ...
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0">
                <div class="d-flex gap-2 flex-wrap">
                  <b-button variant="danger" class="me-1" id="remove-actions" @click="deleteMultiple">
              ...
              <b-row class="g-3">
                ...
                <b-col xxl="3" sm="4">
                  <div class="input-light">
                    ...
                    <Multiselect class="form-control" placeholder="Select Payment Status" v-model="status1" :close-on-select="true" :searchable="true"
