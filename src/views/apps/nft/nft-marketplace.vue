    ...
    <Layout>
                    ...
                    <b-col lg="4" md="6">
                        <b-card no-body>
                            <b-card-body>
                                ...
                                <h5 class="mb-0 fs-16">
                                    <b-link href="#!" class="link-dark">Crypto Card <b-badge variant="soft-success" class="badge-soft-success">743</b-badge>
                                    </b-link>
                                </h5>
                            </b-card-body>
                        </b-card>
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body class="overflow-hidden shadow-none">
                    <b-card-body class="bg-soft-danger text-danger fw-semibold d-flex">
                        <marquee class="fs-14">
        ...
        <b-row>
            <b-col lg="12">
                <div class="d-lg-flex align-items-center mb-4">
                    <div class="flex-grow-1">
                        <h5 class="card-title mb-0 fw-semibold fs-17">Recent NFTs Artwork</h5>
                    </div>
                    <div class="flex-shrink-0 mt-4 mt-lg-0">
