            ...
            <b-row class="justify-content-between gy-3">
              ...
              <b-col lg="auto">
                <div class="d-md-flex text-nowrap gap-2">
                  <b-button variant="info" class="add-btn"><i class="ri-add-fill me-1 align-bottom"></i> Add
                    Categories</b-button>
    ...
    <b-row>
      <b-col lg="12">
        <div class="text-center mb-3">
          <b-button variant="link" class="text-success mt-2" id="loadmore"><i
              class="mdi mdi-loading mdi-spin fs-20 align-middle me-2"></i> Load More </b-button>
        </div>
      </b-col>
    </b-row>
  </Layout>
